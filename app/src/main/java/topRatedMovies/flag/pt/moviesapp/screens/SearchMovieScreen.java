...
import topRatedMovies.flag.pt.moviesapp.adapters.ListMovieSearchViewAdapter;
...
import topRatedMovies.flag.pt.moviesapp.http.requests.GetSearchMovieAsyncTask;
